...
**Install:** About 15 minutes. Clone over HTTPS: `git clone https://github.com/aidendify/afterjob.git`. Documented on Ubuntu 22.04/24.04. Debian 13 uses `docker.io` + `docker-compose`. Amazon Linux notes are not published yet.
